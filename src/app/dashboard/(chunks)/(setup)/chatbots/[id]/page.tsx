...
import { MessageSquare, MessageCircleMore, Plus, MessagesSquareIcon } from "lucide-react";
  ...
  <div className="ml-10 mt-10 flex flex-col flex-grow">
    ...
    <div className="mt-4 pt-4 text-gray-400 space-y-2 overflow-y-auto">
      <div className="flex">
        ...
        <h1 className="text-4xl whitespace-nowrap break-normal font-bold text-gray-300" contentEditable={true}>Untitled</h1>
      </div>
      <div className="">
        <span className="whitespace-nowrap break-normal" contentEditable={true}>Add description</span>
      </div>
      <div className="pt-5">
