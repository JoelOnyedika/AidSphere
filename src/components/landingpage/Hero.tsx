...
import { botCards, landingPageSupportCards } from "@/lib/constants";
...
const Hero = ({ doesSessionExist }: IHero) => {
  return (
    <div className="ml-auto mr-auto pl-[24px] space-y-10 pr-[24px]">
      {/* header text start */}
      ...
      <section>
        <div className="text-center space-y-5">
          <div className="flex flex-col items-center">
            <div className="flex">
              <h2 className="text-[30px] font-extrabold">Spend </h2>
              <h2 className="text-[30px] neon-blue font-extrabold">
                less time {" "}
              </h2>
              <h2 className="text-[30px] font-extrabold">on support</h2>
            </div>
          </div>
          <div className="mt-5 mb-5">
            <p>
              A complete support ecosystem to help you spend less time
              supporting your users - and more time growing your business.
            </p>
          </div>
          <div className=" grid grid-cols-1 gap-8 px-8 md:grid-cols-3 md:px-6 lg:gap-12 container max-w-[1224px] mx-auto pl-[24px] pr-[24px] mt-5">
            {landingPageSupportCards.map((data, i) => (
              <div className="flex w-full relative">
                <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-blue-500 to-teal-500 transform scale-[0.80] bg-red-500 rounded-full blur-3xl" />
                <div className="relative shadow-xl bg-gray-900 border border-gray-800  px-4 py-8 rounded-2xl flex flex-col justify-center items-center">
                  <div className="rounded-full animate-pulse border flex items-center justify-center p-8 mb-4 border-gray-500">
                    <data.icon />
                  </div>
